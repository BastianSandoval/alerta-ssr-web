...
@Component({
  selector: 'app-mobile-complaint-detail-screen',
  templateUrl: './mobile-complaint-detail-screen.component.html',
  styleUrls: ['./mobile-complaint-detail-screen.component.css']
})
export class MobileComplaintDetailScreenComponent implements OnInit {
