...
@Component({
  selector: 'app-desktop-complaint-detail-screen',
  templateUrl: './desktop-complaint-detail-screen.component.html',
  styleUrls: ['./desktop-complaint-detail-screen.component.css']
})
export class DesktopComplaintDetailScreenComponent implements OnInit {
